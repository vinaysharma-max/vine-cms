...
{
  "ok": false,
  "error": "Invalid pageSize query parameter. Maximum allowed value is 100."
}
```
...
The current shipped API supports pagination with `page` and `pageSize`, but it does not yet support:
